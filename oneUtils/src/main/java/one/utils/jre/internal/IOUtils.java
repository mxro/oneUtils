package one.utils.jre.internal;
...
public class IOUtils {
	 ...
	 * @since Commons IO 1.1
	 */
	public static List readLines(final InputStream input, final String encoding)
			throws IOException {
		if (encoding == null) {
	 ...
	 * @since Commons IO 1.1
	 */
	public static void write(final StringBuffer data,
